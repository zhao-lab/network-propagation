function [estusr,H] = olspos(prvec,svxyzmat,initpos,tol,weight_variance)  %modified by macshen, now the matrix H is also output, and weight has been used for WLS
